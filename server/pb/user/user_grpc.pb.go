...
type UserServiceClient interface {
	Register(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserCommonResponse, error)
...
type UserServiceServer interface {
	Register(context.Context, *UserRequest) (*UserCommonResponse, error)
...
func (UnimplementedUserServiceServer) Register(context.Context, *UserRequest) (*UserCommonResponse, error) {
